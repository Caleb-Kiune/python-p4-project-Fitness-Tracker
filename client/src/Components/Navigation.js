...
import { FaHome, FaDumbbell, FaUser, FaClipboard, FaSignInAlt, FaPlusSquare, FaListAlt } from 'react-icons/fa';
    ...
    <div className="navbar">
      <nav aria-label="Main Navigation">
        <ul role="menubar">
          ...
          <li role="none" className={location.pathname === "/profile" ? "active" : ""}><Link to="/profile" role="menuitem"><FaUser aria-hidden="true" /> <span>Profile</span></Link></li>
        </ul>
      </nav>
    </div>
  );
